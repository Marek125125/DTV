...
typedef enum {
    ...
    PDB0_CLK                     = 54u,      
    PDB1_CLK                     = 55u,      
    PCC_END_OF_SYS_CLOCKS        = 56u,      
    FTFC0_CLK                    = 57u,      
    PCC_END_OF_SLOW_CLOCKS       = 58u,      
    FTM0_CLK                     = 59u,      
    FTM1_CLK                     = 60u,      
    FTM2_CLK                     = 61u,      
    FTM3_CLK                     = 62u,      
    PCC_END_OF_ASYNCH_DIV1_CLOCKS= 63u,      
    ADC0_CLK                     = 64u,      
    ADC1_CLK                     = 65u,      
    FLEXIO0_CLK                  = 66u,      
    LPI2C0_CLK                   = 67u,      
    ...
    LPUART0_CLK                  = 72u,      
    LPUART1_CLK                  = 73u,      
    PCC_END_OF_ASYNCH_DIV2_CLOCKS= 74u,      
    PCC_END_OF_CLOCKS            = 75u,      
    CLOCK_NAME_COUNT             = 76u,      
} clock_names_t;
