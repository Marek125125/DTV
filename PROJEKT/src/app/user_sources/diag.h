...
* 2) needed interfaces from external modules
* 3) internal and external interfaces from this module
==================================================================================================*/
...
void read_data_request(bios_can_msg_typ* msg);
