...
#define NUMBER_OF_INT_VECTORS 163u               
...
typedef struct {
  ...
  __IO uint32_t aSC1[ADC_aSC1_COUNT];              
  __I  uint32_t aR[ADC_aR_COUNT];                  
...
typedef struct {
  __IO uint32_t MPRA;                              
       uint8_t RESERVED_0[28];
  __IO uint32_t PACR[AIPS_PACR_COUNT];             
       uint8_t RESERVED_1[16];
  __IO uint32_t OPACR[AIPS_OPACR_COUNT];           
...
typedef struct {
  ...
  __I  uint8_t FSEC;                               
  __I  uint8_t FOPT;                               
  __IO uint8_t FCCOB[FTFC_FCCOB_COUNT];            
  __IO uint8_t FPROT[FTFC_FPROT_COUNT];            
...
typedef struct {
  ...
  __IO uint32_t CV_MIRROR[FTM_CV_MIRROR_COUNT];    
...
typedef struct {
  ...
  __O  uint32_t TDR[SAI_TDR_COUNT];                
       uint8_t RESERVED_0[16];
  __I  uint32_t TFR[SAI_TFR_COUNT];                
       uint8_t RESERVED_1[16];
  __IO uint32_t TMR;                               
  ...
  __I  uint32_t RFR[SAI_RFR_COUNT];                
       uint8_t RESERVED_4[16];
  __IO uint32_t RMR;                               
